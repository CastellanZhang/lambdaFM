...
string train_help() 
{
    return string(
            ...
            "-dim <k1,k2>: k1=use 1-way interactions, k2=dim of 2-way interactions\tdefault:1,8\n"
            ...
            "-rank <ranking_loss>: pairwise or ndcg\tdefault:pairwise\n"
            "-fast_mode <fast_mode>: if 1, use fast mode\tdefault:0\n"
    );
}
